"""
Django settings for helloworld_46238 project.
...
ROOT_URLCONF = 'helloworld_46238.urls'
...
WSGI_APPLICATION = 'helloworld_46238.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "helloworld_46238 API",
    "DESCRIPTION": "API documentation for helloworld_46238 App",
    "VERSION": "v1",
}
